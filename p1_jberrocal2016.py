...
class Checker(TwoPlayerGame):
    ...
    def make_move(self, pos):
        ...
        if self.current_player == 1:
            color = "W"
        indices = np.where(pos == color)
        indices = list(zip(indices[0], indices[1]))
        self.player.pos =  indices #my code
        # #pass
       
        # self.players[].pos = list(pos)
        # pass
    ...
    def lose(self):
        ...
        for x in self.players[0].pos:
            if x in self.black_territory:
                return True
        for y in self.players[1].pos:
            if y in self.white_territory:
                return True
    ...
    def is_over(self):
        ...
        """
        return (self.possible_moves() == []) or self.lose() #my code
    ...
    def scoring(self):
       ...
       lose = -100
       """
       return -100 if self.lose() else 0 #my code
       #pass
